export default function ExportModal({ open, onClose, onExportSql, onExportMigrations, onExportJson }) {
    if (!open) {
        return null;
    }
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 p-4">
            <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-xl">
                ...
                <p className="mt-1 text-sm text-slate-500">Choose one of the available export formats.</p>
